...
public class Derrota : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        Vector2 label1 = GUI.skin.label.CalcSize(new GUIContent("Derrota"));
        GUI.Label(new Rect((Screen.width-label1.x)/2, (Screen.height-label1.y)/2-30, label1.x+5, label1.y), "Derrota");
